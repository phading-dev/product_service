...
import { UpdateNextSeasonGradeHandler } from "./update_next_season_grade_handler";
...
TEST_RUNNER.run({
  name: "UpdateNextSeasonGradeHandlerTest",
  cases: [
    {
      ...
      execute: async () => {
        ...
        let id = 0;
        let handler = new UpdateNextSeasonGradeHandler(
          SPANNER_DATABASE,
          serviceClientMock,
        ...
        assertThat(
          ...
          eqHttpError(
            newBadRequestError(
              `"effectiveDate" 2020-01-02 must be at least 2 days apart from today 2020-01-01`,
            ),
          ),
          "Error",
        );
            ...
            eqMessage(
              {
                ...
                seasonLastChangeTimeMs: new Date("2020-01-01T08:00:00Z").getTime(),
    ...
    },
    {
      ...
      execute: async () => {
        ...
        assertThat(
          ...
          eqHttpError(
            newBadRequestError(
              `"effectiveDate" 2020-01-01 must be at least 2 days apart from today 2019-12-31`,
            ),
          ),
          "Error",
        );
            ...
            eqMessage(
              {
                ...
                seasonPublisherId: "publisher1",
                seasonState: SeasonState.PUBLISHED,
                seasonLastChangeTimeMs: new Date("2020-01-01T01:00:00Z").getTime(),
                seasonCreatedTimeMs: 1000,
              },
              GET_SEASON_ROW,
            ),
    ...
    },
    {
      ...
      execute: async () => {
        ...
        assertThat(
          ...
          eqHttpError(
            newBadRequestError(
              `Season season1 is not in PUBLISHED state and cannot update next season grade.`,
            ),
          ),
          "Error",
        );
