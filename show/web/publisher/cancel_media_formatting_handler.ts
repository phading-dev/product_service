...
import { cancelMediaFormatting } from "@phading/video_service_interface/node/client";
import {
  newBadRequestError,
  newNotFoundError,
  ...
  public async handle(
    ...
    if (!capabilities.canPublishShows) {
      throw newUnauthorizedError(
        `Account ${accountId} not allowed to cancel media formatting.`,
      );
    }
    ...
    await cancelMediaFormatting(this.serviceClient, {
