...
import { cancelSubtitleFormatting } from "@phading/video_service_interface/node/client";
import {
  newBadRequestError,
  newNotFoundError,
  ...
  public async handle(
    ...
    if (!canPublishShows) {
      throw newUnauthorizedError(
        `Account ${accountId} not allowed to cancel subtitle formatting.`,
      );
    }
    ...
    await cancelSubtitleFormatting(this.serviceClient, {
