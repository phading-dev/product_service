...
import { deleteSubtitleTrack } from "@phading/video_service_interface/node/client";
import {
  newBadRequestError,
  newNotFoundError,
  ...
  public async handle(
    ...
    if (!canPublishShows) {
      throw newUnauthorizedError(
        `Account ${accountId} not allowed to delete subtitle track.`,
      );
    }
    ...
    await deleteSubtitleTrack(this.serviceClient, {
