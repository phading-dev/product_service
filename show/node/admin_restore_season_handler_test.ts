...
import { AdminRestoreSeasonHandler } from "./admin_restore_season_handler";
...
TEST_RUNNER.run({
  name: "AdminRestoreSeasonHandlerTest",
  cases: [
    {
      name: "Success",
      execute: async () => {
        ...
        let handler = new AdminRestoreSeasonHandler(SPANNER_DATABASE);
